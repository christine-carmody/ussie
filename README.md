...
[![R-CMD-check](https://github.com/christine-carmody/ussie/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/christine-carmody/ussie/actions/workflows/R-CMD-check.yaml)
[![test-coverage](https://github.com/christine-carmody/ussie/actions/workflows/test-coverage.yaml/badge.svg)](https://github.com/christine-carmody/ussie/actions/workflows/test-coverage.yaml)
<!-- badges: end -->

The goal of ussie is to allow you to work with European football league
...
devtools::install_github("christine-carmody/ussie")
```
